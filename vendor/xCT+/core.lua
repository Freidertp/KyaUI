...
function x:UpdateComboPointOptions(force)
  ...
  for name in pairs(x.db.profile.spells.combo[myClass] or {}) do
  ...
  -- Add the each spec
  for spec in ipairs(x.db.profile.spells.combo[myClass] or {}) do
...
function x:UpdateComboTracker()
  ...
  for i, entry in pairs((x.db.profile.spells.combo[myClass] or {})[mySpec] or {}) do
