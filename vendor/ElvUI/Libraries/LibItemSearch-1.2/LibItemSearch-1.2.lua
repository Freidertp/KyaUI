...
for i = 0, #ITEM_QUALITY_COLORS do
	local qualityDesc = _G["ITEM_QUALITY" .. i .. "_DESC"] -- guard: calidad custom sin _DESC en este cliente
	Lib.Filters.quality.keywords[i] = qualityDesc and qualityDesc:lower()
end
