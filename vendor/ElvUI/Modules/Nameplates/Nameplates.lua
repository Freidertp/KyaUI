...
function NP:UnitClass(frame, unitType)
	...
	elseif unitType == "ENEMY_PLAYER" then
		if not frame.oldHealthBar then return end -- guard: placa aún sin construir en cliente HD
...
function NP:GetUnitInfo(frame)
	if not (frame and frame.oldHealthBar) then return 3, "ENEMY_PLAYER" end -- guard: placa aún sin construir en cliente HD
