...
function mod:AddonList()
	...
	if GameMenuFrame then -- guard: cliente custom sin menú ESC estándar
	...
	if GameMenuButtonRatings then -- guard: cliente custom sin GameMenuButtonRatings
